...
final class Version20220307161026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pedido (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, id_tienda_id INT NOT NULL, INDEX IDX_C4EC16CE79F37AE5 (id_user_id), INDEX IDX_C4EC16CE998FD161 (id_tienda_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, tipo_producto VARCHAR(255) NOT NULL, precio NUMERIC(10, 0) NOT NULL, stock INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pedido ADD CONSTRAINT FK_C4EC16CE998FD161 FOREIGN KEY (id_tienda_id) REFERENCES tienda (id)');
